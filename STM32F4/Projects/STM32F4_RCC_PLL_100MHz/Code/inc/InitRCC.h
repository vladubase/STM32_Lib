...
#define f_PLL_IN	25e6						// PLL clock input. Quartz resonator clock.
...
#define f_VCO		f_PLL_IN * PLL_N / PLL_M	// VCO clock.
...
#define f_HCLK		f_SYSCLK / AHB_PRESCALER	// HCLK to AHB bus, core, memory, DMA;
